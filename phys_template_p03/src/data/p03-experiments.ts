...
const P03_EXPERIMENTS: Record<ModuleId, ExperimentSpec[]> = {
  refraction: [
    {
      ...
      category: 'refraction',
      formulas: ['n₁ sin θ₁ = n₂ sin θ₂', 'sin θc = n₂ / n₁（当 n₁ > n₂ 时）'],
      teachingPoints: ['折射角由两侧折射率共同决定', '当 n₁ > n₂ 且入射角继续增大时会出现全反射'],
      params: [
    ...
    },
    {
      ...
      category: 'refraction',
      formulas: ['n₁ sin θ₁ = n₂ sin θ₂', 'Δ = d sin(θ₁ − θ₂) / cos θ₂'],
    ...
    },
    {
      ...
      category: 'refraction',
      formulas: ['sin θc = n₂ / n₁', '光在纤芯-包层界面全反射'],
      teachingPoints: ['n₁ 必须大于 n₂', '弯曲半径越小越容易漏光'],
      params: [
      ...
      defaults: { experimentId: 'opt-004', shape: 'fiber', theta1Deg: 25, fiberCoreN: 1.5, fiberCladdingN: 1.3, fiberModel: 'straight', fiberBendRadiusCm: 10, wavelength: 550, material: 'fiber' },
      visualConfig: { showAngles: true, showNormals: true, showColor: true, lightMode: 'single' },
    },
    {
      id: 'opt-005',
      ...
      category: 'refraction',
      formulas: ['h\' = h / n（视深，从空气看水中物体）', 'h\' = h × n（视高，从水中看空气物体）'],
      teachingPoints: ['视深：水中物体看起来比实际位置浅', '视高：水上物体从水下看显得更高', '近轴近似下虚像位置与折射率成简单比例关系'],
      params: [
      ...
      defaults: { experimentId: 'opt-005', shape: 'apparent', apparentMode: 'depth', apparentObjectDepthCm: 5, apparentWaterN: 1.333, wavelength: 550 },
    ...
    },
    {
      ...
      category: 'refraction',
      formulas: ['sin θc = 1/n', 'r = h tan θc'],
      teachingPoints: ['临界角锥内的光线折射出水面', '锥外光线全部全反射回水中', '斯涅尔窗是鱼眼看到的整个外部世界'],
      params: [
      ...
      defaults: { experimentId: 'opt-006', shape: 'snellwindow', snellSourceDepthCm: 8, snellSourceShape: 'point', snellSourceSizeCm: 4, snellPolygonSides: 5, snellWaterN: 1.333, snellIncidentAngleDeg: 30, snellViewMode: '3d', wavelength: 550 },
  ...
  thinfilm: [
    ...
    },
    {
      ...
      defaults: { experimentId: 'opt-042', filmType: 'wedge', wedgeAngle: 1.0, wedgeProfile: 'linear', filmN: 1.5, wavelength: 550 },
      visualConfig: { showIntensity: true, showFormula: true },
    },
    {
      id: 'opt-043',
