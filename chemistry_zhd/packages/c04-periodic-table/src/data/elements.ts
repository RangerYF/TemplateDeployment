...
export interface ChemicalElement {
  ...
  /** 第一电离能（kJ/mol）。人工合成元素（Z≥93）无可靠实测值，为 null */
...
/**
 * 第一电离能（kJ/mol），数据范围 Z=1..92（天然存在 / 有可靠实测值）。
 * 人工合成元素（Z≥93）实测值不可靠，不收录，详情面板显示“—”。
 * 关键反常点（教学高频）：Mg>Al、P>S、N>O、Be>B、Zn>Ga，均已按实测值保留。
 */
const FIRST_IONIZATION_ENERGY: Record<number, number> = {
  1: 1312.0, 2: 2372.3, 3: 520.2, 4: 899.5, 5: 800.6, 6: 1086.5, 7: 1402.3,
  8: 1313.9, 9: 1681.0, 10: 2080.7, 11: 495.8, 12: 737.7, 13: 577.5, 14: 786.5,
  15: 1011.8, 16: 999.6, 17: 1251.2, 18: 1520.6, 19: 418.8, 20: 589.8, 21: 633.1,
  22: 658.8, 23: 650.9, 24: 652.9, 25: 717.3, 26: 762.5, 27: 760.4, 28: 737.1,
  29: 745.5, 30: 906.4, 31: 578.8, 32: 762.0, 33: 947.0, 34: 941.0, 35: 1139.9,
  36: 1350.8, 37: 403.0, 38: 549.5, 39: 600.0, 40: 640.1, 41: 652.1, 42: 684.3,
  43: 702.0, 44: 710.2, 45: 719.7, 46: 804.4, 47: 731.0, 48: 867.8, 49: 558.3,
  50: 708.6, 51: 834.0, 52: 869.3, 53: 1008.4, 54: 1170.4, 55: 375.7, 56: 502.9,
  57: 538.1, 58: 534.4, 59: 527.0, 60: 533.1, 61: 540.0, 62: 544.5, 63: 547.1,
  64: 593.4, 65: 565.8, 66: 573.0, 67: 581.0, 68: 589.3, 69: 596.7, 70: 603.4,
  71: 523.5, 72: 658.5, 73: 728.4, 74: 758.8, 75: 755.8, 76: 814.2, 77: 865.2,
  78: 864.4, 79: 890.1, 80: 1007.1, 81: 589.4, 82: 715.6, 83: 703.0, 84: 812.1,
  85: 899.0, 86: 1037.0, 87: 393.0, 88: 509.3, 89: 499.0, 90: 608.5, 91: 568.0,
  92: 597.6,
};
...
] as Omit<ChemicalElement, "firstIonizationEnergy">[]);

export const elements: ChemicalElement[] = elementsRaw.map((e) => ({
  ...e,
  firstIonizationEnergy: FIRST_IONIZATION_ENERGY[e.atomicNumber] ?? null,
}));
