...
import { fmt, fmtVec2D, fmtVec3D, fmtSurd, fmtVec2DSurd, fmtVec3DSurd, fmtSurdLatex } from '@/engine/vectorMath';
...
export function useFmt() {
  ...
  return {
    ...
    fl: (n: number, customDp?: number) => fmtSurdLatex(n, customDp ?? dp),
